...
public class concesionario {
    ...
    public static void aniadirVendedor(vendedor vendedor) throws ObjetoNoEncontrado{

        if(listaVendedores.containsKey(vendedor.getCodven())) throw new ObjetoNoEncontrado(("El vendedor ya está en la lista de vendedores"));
        listaVendedores.put(vendedor.getCodven(), vendedor);
    }


    public static void modificarVendedor(String codven, String nombre, String domicilio, int telefono) throws ObjetoNoEncontrado {
        if(listaVendedores.containsKey(codven)) throw  new ObjetoNoEncontrado("El vendedor para modificar non se encuentra en la lista de vendedores");
